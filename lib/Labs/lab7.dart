...
class _Lab07State extends State<Lab07> {
  ...
  Widget build(BuildContext context) {
    MyApp.analytics
        .logEvent(name: 'flutter_labs_lab7_tab_was_opened', parameters: null);
    return Scaffold(
      body: Container(
...
class MessageInput extends StatefulWidget {
  ...
  MessageInput({required this.textEditingController, required this.onPressed});
...
class _HomeScreenState extends State<HomeScreen> {
  final IOWebSocketChannel channel =
      IOWebSocketChannel.connect('wss://lebedev-labs.herokuapp.com/submit');
              ...
              child: StreamBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  if (snapshot.data == null) {
                    ...
                    Message message = Message.fromJson(jsonDecode(snapshot.data.toString()));
                    if (messages.isEmpty) {
