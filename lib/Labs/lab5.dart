...
class Lab05State extends State<Lab05> {
  ...
  Future getUserContacts() async {
    ...
    const endPoint = "/v1/people/me/connections?personFields=names,phoneNumbers";
    ...
    final request = await http.get(Uri.parse("$host$endPoint"), headers: header);
  ...
  Widget build(BuildContext context) {
    MyApp.analytics
        .logEvent(name: 'flutter_labs_lab5_tab_was_opened', parameters: null);
    return Scaffold(
      body: Container(
